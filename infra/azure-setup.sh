...
echo "  az containerapp update --name $CONTAINER_APP --resource-group $RESOURCE_GROUP --set-env-vars AI_INTEGRATIONS_OPENAI_API_KEY=<key> AI_INTEGRATIONS_ANTHROPIC_API_KEY=<key>"
echo ""

...
const DEMO_RESPONSES: Record<string, string> = {
  ...
  "pricing": "GoRigo offers two deployment packages:\n\n**Managed Package** — £500 setup, £0.20/minute\n• Full-service AI call centre\n• Includes agent configuration and monitoring\n• Perfect for businesses getting started\n\n**White-Label Package** — £1,000 setup, £0.12/minute\n• For partners and resellers\n• Your branding, our technology\n• Higher volume, lower per-minute rate\n\nWould you like to know more about either package?",

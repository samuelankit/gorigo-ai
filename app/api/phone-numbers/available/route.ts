  ...
  try {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        return NextResponse.json({ numbers: [], error: "Failed to fetch available numbers", details: errBody }, { status: 502 });
      }
    ...
    return handleRouteError(error, "GET /api/phone-numbers/available");
  }
}
